...
class MasterSpecialtyPageDocumentController extends Controller
{
    ...
    public function store(Request $request, $mastersSpecialtyId)
    {
        ...
        return redirect('admin/mastersSpecialty/' . $mastersSpecialtyId . '/page/documents')->with('flash_message', 'Блок добавлен');
    }
    ...
    public function update(Request $request, $id, $mastersSpecialtyId)
    {
        ...
        return redirect('admin/mastersSpecialty/' . $mastersSpecialtyId . '/page/documents')->with('flash_message', 'Блок изменен');
    }
    ...
    public function destroy($mastersSpecialtyId, $id)
    {
        ...
        return redirect('admin/mastersSpecialty/' . $mastersSpecialtyId . '/page/documents')->with('flash_message', 'Блок удален');
    }
}
