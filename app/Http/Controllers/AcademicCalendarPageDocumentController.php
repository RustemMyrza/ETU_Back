...
class AcademicCalendarPageDocumentController extends DocumentController
{
    protected $modelClass = AcademicCalendarPageDocument::class;
    protected $viewName = 'academicCalendarPageDocument';
    protected $redirectUrl = 'admin/academicCalendarPageDocument';
    ...
    {
        return view('academicCalendarPageDocument.create');
    }
