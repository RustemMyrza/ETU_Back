...
class AccreditationPageDocumentController extends DocumentController
{
    protected $modelClass = AccreditationPageDocument::class;
    protected $viewName = 'accreditationPageDocument';
    protected $redirectUrl = 'admin/accreditationPageDocument';
    ...
    {
        return view('accreditationPageDocument.create');
    }
