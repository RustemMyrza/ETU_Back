...
class SummerSchoolDocumentController extends DocumentController
{
    protected $modelClass = SummerSchoolDocument::class;
    protected $viewName = 'summerSchoolDocument';
    protected $redirectUrl = 'admin/summerSchoolDocument';
    ...
    {
        return view('summerSchoolDocument.create');
    }
