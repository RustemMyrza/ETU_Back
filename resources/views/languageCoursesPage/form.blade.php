...
<div class="form-group {{ $errors->has('image') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="image" type="file" id="image" value="{{ isset($languageCoursesPage->image) ? $languageCoursesPage->image : ''}}" >
    {!! $errors->first('image', '<p class="help-block">:message</p>') !!}
</div>
@if (isset($languageCoursesPage->image))
    <div class="form-group">
        <img src="{{ \Config::get('constants.alias.cdn_url').$languageCoursesPage->image }}" alt="" width="300px;">
    </div>
@endif
