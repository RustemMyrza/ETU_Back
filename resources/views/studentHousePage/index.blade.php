...
@section('content')
    ...
    <div class="card-body">
        ...
        <a href="{{ url('/admin/studentHousePage/create') }}" class="btn btn-success btn-sm" title="Добавить новый блок">
            <i class="fa fa-plus" aria-hidden="true"></i> Добавить
        </a>

        <form method="GET" action="{{ url('/admin/studentHousePage') }}" accept-charset="UTF-8"
                        ...
                        @if($item->getContent != null)
                            <tr>
                                ...
                                <a href="{{ url('/admin/studentHousePage/' . $item->id) }}" title="Посмотреть блок"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> Просмотр</button></a>
                                    ...
                                    <form method="POST" action="{{ url('/admin/studentHousePage' . '/' . $item->id) }}"
