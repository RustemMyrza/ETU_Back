...
@section('content')
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ url('/admin/instagramImage') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
            {{ csrf_field() }}

            @include ('instagramImage.form', ['formMode' => 'create'])
