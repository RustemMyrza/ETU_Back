...
@section('content')
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ url('admin/militaryDepartmentPage' . '/' . $militaryDepartmentPage->id) }}" accept-charset="UTF-8" style="display:inline">
            {{ method_field('DELETE') }}
            {{ csrf_field() }}
        ...
        <div class="table-responsive">
            <table class="table">
                <tbody>
                    ...
                    <tr><th> Изображение </th><td><img src="{{\Config::get('constants.alias.cdn_url').$militaryDepartmentPage->image}}" alt="url($militaryDepartmentPage->image)" width="200px;"></td></tr>
                </tbody>
            </table>
        </div>
    </div>
