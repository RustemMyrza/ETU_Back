...
@section('content')
    ...
    <div class="card-body">
        ...
        <a href="{{ url('/admin/levelUpPage/create') }}" class="btn btn-success btn-sm" title="Добавить новый блок">
            <i class="fa fa-plus" aria-hidden="true"></i> Добавить
        </a>

        <form method="GET" action="{{ url('/admin/levelUpPage') }}" accept-charset="UTF-8"
                        ...
                        @if($item->getContent != null)
                            <tr>
                                ...
                                <a href="{{ url('/admin/levelUpPage/' . $item->id) }}" title="Посмотреть блок"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> Просмотр</button></a>
                                    ...
                                    <form method="POST" action="{{ url('/admin/levelUpPage' . '/' . $item->id) }}"
