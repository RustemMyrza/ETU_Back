...
@section('content')
    ...
    <div class="card-body">
        ...
        <a href="{{ url('/admin/navbar/create') }}" class="btn btn-success btn-sm" title="Добавить новый блок">
            <i class="fa fa-plus" aria-hidden="true"></i> Добавить
        </a>

        <form method="GET" action="{{ url('/admin/navbar/create') }}" accept-charset="UTF-8"
