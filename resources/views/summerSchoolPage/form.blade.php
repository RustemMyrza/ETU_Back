...
<div class="form-group {{ $errors->has('image') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="image" type="file" id="image" value="{{ isset($summerSchoolPage->image) ? $summerSchoolPage->image : ''}}" >
    {!! $errors->first('image', '<p class="help-block">:message</p>') !!}
</div>
@if (isset($summerSchoolPage->image))
    <div class="form-group">
        <img src="{{ url($summerSchoolPage->image) }}" alt="" width="300px;">
    </div>
@endif
