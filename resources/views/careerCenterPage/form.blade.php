...
<div class="form-group {{ $errors->has('image') ? 'has-error' : ''}}">
    ...
    <input class="form-control" name="image" type="file" id="image" value="{{ isset($careerCenterPage->image) ? $careerCenterPage->image : ''}}" >
    {!! $errors->first('image', '<p class="help-block">:message</p>') !!}
</div>
@if (isset($careerCenterPage->image))
    <div class="form-group">
        <img src="{{ \Config::get('constants.alias.cdn_url').$careerCenterPage->image }}" alt="" width="300px;">
    </div>
@endif
