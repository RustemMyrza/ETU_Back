        ...
        <div class="table-responsive">
            <table class="table">
                <tbody>
                    ...
                    <tr><th> Изображение </th><td><img src="{{\Config::get('constants.alias.cdn_url').$internationalStudentsPage->image}}" alt="url($internationalStudentsPage->image)" width="200px;"></td></tr>
                </tbody>
            </table>
        </div>
    </div>
