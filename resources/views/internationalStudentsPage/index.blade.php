...
@section('content')
    ...
    <div class="card-body">
        ...
        <a href="{{ url('/admin/internationalStudentsPage/create') }}" class="btn btn-success btn-sm" title="Добавить новый блок">
        ...
        <form method="GET" action="{{ url('/admin/internationalStudentsPage') }}" accept-charset="UTF-8"
                        ...
                        @if($item->getContent != null)
                            <tr>
                                ...
                                <a href="{{ url('/admin/internationalStudentsPage/' . $item->id) }}" title="Посмотреть блок"><button class="btn btn-info btn-sm"><i class="fa fa-eye" aria-hidden="true"></i> Просмотр</button></a>
                                    ...
                                    <form method="POST" action="{{ url('/admin/internationalStudentsPage' . '/' . $item->id) }}"
