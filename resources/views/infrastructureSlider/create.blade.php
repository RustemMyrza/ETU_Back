...
@section('content')
    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ url('/admin/infrastructureSlider') }}" accept-charset="UTF-8" class="form-horizontal" enctype="multipart/form-data">
            {{ csrf_field() }}

            @include ('infrastructureSlider.form', ['formMode' => 'create'])
